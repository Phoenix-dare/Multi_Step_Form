...
const Summary = () => {
  return (
    <div className="flex flex-col w-[22rem] h-[26rem] rounded-md relative -top-28 p-6 bg-white z-4 md:w-[32rem] md:h-[36rem] md:ml-12 md:mr-8 md:mt-8 md:p-4  items-center justify-center text-center">
      <svg
      ...
      <p className="font-ubuntu-regular font-semi-bold text-sm text-cool-gray my-4 w-full px-6 md:w-4/5">
